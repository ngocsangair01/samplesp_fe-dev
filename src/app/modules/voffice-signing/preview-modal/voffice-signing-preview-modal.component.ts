...
declare var $: any;
@Component({
    selector: 'voffice-signing-preview-modal',
    templateUrl: './voffice-signing-preview-modal.component.html',
    styleUrls: ['./voffice-signing-preview-modal.component.css']
})
export class VofficeSigningPreviewModalComponent extends BaseComponent implements OnInit {
