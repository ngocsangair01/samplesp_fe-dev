...
@Component({
  selector: 'policy-org-tree-selector',
  templateUrl: './policy-org-tree-selector.component.html',
})
export class PolicyOrgTreeSelectorComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.isView = subPaths[2] === 'request-policy-program-view';
  ...
  public actionInitAjax() {
    this.service.actionInitAjaxAllPolicy(this.getParams())
        .subscribe((res) => {
