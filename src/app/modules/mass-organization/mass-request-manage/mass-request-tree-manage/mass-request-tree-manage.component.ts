...
@Component({
  selector: 'mass-request-tree-manage',
  templateUrl: './mass-request-tree-manage.component.html',
})
export class MassRequestTreeManageComponent implements OnInit {
  ...
  constructor( private service: MassCriteriaService,
...
// for context menu
  ...
  */
  ...
  setDataNodes(requestResolutionBO, dataNodes) {
    this.dataNodes = CommonUtils.toTreeNodeTableForCriteria(dataNodes);
    // TH set root node
    if (requestResolutionBO) {
      this.rootNode.children = dataNodes;
      this.rootNode.data = requestResolutionBO;
      this.rootNode.data.name = requestResolutionBO.massRequestName;
      this.rootNode.data.status = null;
      this.rootNode.dataTable = requestResolutionBO;
      this.rootNode.nodeId = requestResolutionBO.massRequestId;
      this.rootNode.label = requestResolutionBO.massRequestName;
      this.rootNode.title = requestResolutionBO.massRequestName;
