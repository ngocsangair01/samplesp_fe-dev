...
@Component({
  selector: 'report-submission-history',
  templateUrl: './report-submission-history.component.html',
})
export class ReportSubmissionHistoryComponent extends BaseComponent implements OnInit{
  data: [];
  recordsTotal: any;
  resultList: any;
  parseInt = parseInt;
