...
@Component({
  selector: 'setting-icon-form',
  templateUrl: './setting-icon-form.component.html',
  styleUrls: ['./setting-icon-form.component.css']
})
export class SettingIconFormComponent extends BaseComponent implements OnInit {
