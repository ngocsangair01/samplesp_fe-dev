...
@Component({
  selector: 'decided-reward-cost',
  templateUrl: './decided-reward-cost.component.html',
  styleUrls: ['./decided-reward-cost.component.css']
})
export class DecidedRewardCostComponent extends BaseComponent implements OnInit {
