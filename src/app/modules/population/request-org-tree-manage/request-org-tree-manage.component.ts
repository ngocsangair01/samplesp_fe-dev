...
@Component({
  selector: 'request-org-tree-manage',
  templateUrl: './request-org-tree-manage.component.html',
})
export class RequestOrgTreeManageComponent implements OnInit {
  ...
  constructor( private service: RequestOrgTreeService,
