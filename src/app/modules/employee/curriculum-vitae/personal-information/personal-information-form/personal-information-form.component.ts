...
export class PersonalInformationFormComponent extends BaseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.curriculumVitaeService.saveCurriculumVitae.subscribe(res => {
      this.doSaveOrUpdate();
    })
  ...
  public doSaveOrUpdate() {
    ...
    this.app.confirmMessage(null, () => { // on accepted
      ...
      formSave['securityProtectionForm'].expressionViolationIdList = this.fSecurityProtection['expressionViolationIdList'].value.map(x => x.sysCatId);
