...
export class EmployeeT63InfomationFormComponent extends BaseComponent implements OnInit {
  ...
  textAreaControlList = ['t36Abroad', 't36PriorRevolution', 't36Housing', 't36Diseases', 't36FamilyDesciption', 't36MarriageFamilyDesciption', 't36Review', 't36Suggestion'];
  ...
  formConfig = {
    ...
    t36MarriageTypeId: [''],
    t36FamilyComponent: [''],
    t36MarriageFamilyComponent: [''],
    t36Review: ['', [ValidationService.maxLength(60000)]],
    t36Suggestion: ['', [ValidationService.maxLength(500)]],
  };
      ...
      data => {
        if (data) {
          ...
          this.employeeT63InfomationService.findOne(this.employeeId).subscribe(res => {
            ...
            this.onBlurTextArea(this.f['t36Suggestion'], 't36Suggestion', 18, null, 96);
          });
        }
      }
    );
  ...
  ngOnInit() {
    ...
    this.curriculumVitaeService.saveEmployeeInformation.subscribe(res => {
      this.doSaveOrUpdate();
    })
    this.curriculumVitaeService.exportEmployeeInformation.subscribe(res => {
      this.activeModal();
    })
