...
@Component({
  selector: 'resolutions-quarter-year-tree-manage',
  templateUrl: './resolutions-quarter-year-tree-manage.component.html'
})
export class ResolutionsQuarterYearTreeManageComponent implements OnInit {
  ...
  constructor( private service: CriteriaPlanService,
...
actionActiveModal(item) {
  ...
  setDataNodes(requestResolutionBO, dataNodes) {
    ...
    if (requestResolutionBO) {
      ...
      this.rootNode.data.name = requestResolutionBO.resolutionsName;
