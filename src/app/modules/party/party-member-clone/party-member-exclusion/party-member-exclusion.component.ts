...
@Component({
    selector: 'party-member-exclusion',
    templateUrl: './party-member-exclusion.component.html'
})
export class PartyMemberExclusionComponent extends BaseComponent implements OnInit {
