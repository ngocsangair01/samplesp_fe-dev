...
@Component({
  selector: 'party-member-report-clone',
  templateUrl: './party-member-report-clone.component.html'
})
export class PartyMemberReportCloneComponent extends BaseComponent implements OnInit {
