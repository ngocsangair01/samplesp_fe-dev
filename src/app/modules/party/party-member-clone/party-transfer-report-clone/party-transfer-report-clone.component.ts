...
@Component({
  selector: 'party-transfer-report-clone',
  templateUrl: './party-transfer-report-clone.component.html'
})
export class PartyTransferReportCloneComponent extends BaseComponent implements OnInit {
