...
@Component({
  selector: 'committees-report-clone',
  templateUrl: './committees-report-clone.component.html',
})
export class CommitteesReportCloneComponent extends BaseComponent implements OnInit {
