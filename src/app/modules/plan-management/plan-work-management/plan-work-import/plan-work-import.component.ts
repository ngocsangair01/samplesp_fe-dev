...
@Component({
  ...
  templateUrl: './plan-work-import.component.html',
  styleUrls: ['./plan-work-import.component.css']
})
export class PlanWorkImportComponent extends BaseComponent implements OnInit {
