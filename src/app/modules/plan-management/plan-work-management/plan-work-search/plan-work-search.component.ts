...
@Component({
  ...
  templateUrl: './plan-work-search.component.html',
  styleUrls: ['./plan-work-search.component.css']
})
export class PlanWorkSearchComponent extends BaseComponent implements OnInit {
  ...
  public prepareSaveOrUpdate(item?: any) {
    if (item && item.punishmentId > 0) {
      this.router.navigate(['/plan-management/plan-work-management/edit/', item.punishmentId]);
    } else {
      this.router.navigate(['/plan-management/plan-work-management/add']);
    }
  }
