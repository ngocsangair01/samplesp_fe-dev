...
import { PlanManagementCategoryRoutingModule } from './plan-management-category-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    SharedModule,
    PlanManagementCategoryRoutingModule
  ],
...
export class PlanManagementCategoryModule { }
