...
@Component({
  selector: 'worked-abroad-import',
  templateUrl: './worked-abroad-import.component.html',
  styleUrls: ['./worked-abroad-import.component.css']
})
export class WorkedAbroadImportComponent extends BaseComponent implements OnInit {
  formConfig = {
  };
  ...
  processImport() {
    ...
    this.app.confirmMessage(null, () => {// on accepted
      this.workedAbroadService.processImport(this.formImport.value).subscribe(res => {
        if (res.type !== 'SUCCESS') {
  ...
  processDownloadTemplate() {
    ...
    this.workedAbroadService.downloadTemplateImport(params).subscribe(res => {
