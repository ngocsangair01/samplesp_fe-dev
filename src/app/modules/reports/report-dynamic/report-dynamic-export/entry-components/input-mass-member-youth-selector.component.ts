  ...
  template: `
    ...
    <div class="ui-g-6 ui-md-3 ui-lg-2">
      <data-picker
        ...
        filterCondition=" AND EXISTS (SELECT 1 FROM mass_member mm WHERE mm.employee_id = obj.employee_id AND mm.branch = 2)"
      >
      </data-picker>
...
export class InputMassMemberYouthSelectorComponent implements ReportInputGenerateComponent {
