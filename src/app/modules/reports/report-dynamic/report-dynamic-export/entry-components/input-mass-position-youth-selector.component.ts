  ...
  template: `
    ...
    <div class="ui-g-6 ui-md-3 ui-lg-2">
      <data-picker
        ...
        objectBO="MassPositionBO"
        codeField="code"
        nameField="name"
        selectField="massPositionId"
        [isRequiredField]="control.isRequire"
        filterCondition=" AND obj.branch = 2 "
      >
      </data-picker>
...
export class InputMassPositionYouthSelectorComponent implements ReportInputGenerateComponent {
