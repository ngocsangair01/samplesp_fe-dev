...
@Component({
    template: `
        <label [ngClass]="{'required': control.isRequire}"
               class="ui-g-6 ui-md-3 ui-lg-1 control-label vt-align-right required" style="margin-top: 8px;">
            {{ label }}
        </label>
        <div class="ui-g-6 ui-md-3 ui-lg-2">
            <mass-org-selector [property]="control" operationKey="action.view"
                               adResourceKey="resource.reportDynamic" [defaultValue]="true"
...
export class InputUnionOrgNoPermissionSelectorComponent implements ReportInputGenerateComponent {
