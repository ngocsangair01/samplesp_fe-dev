...
export class RequestOrgTreeService extends BasicService {

  constructor(public httpClient: HttpClient, public helperService: HelperService) {
    super('political', 'requestOrgTree', httpClient, helperService);
  }
  /**
   ...
   * action load org tree
   */
  public actionInitAjaxAllPolicy(params: any): Observable<any> {
    const url = `${this.serviceUrl}/action-init-ajax-all-policy`;
    return this.postRequest(url, params);
  }
