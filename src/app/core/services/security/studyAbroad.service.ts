...
export class StudyAbroadService extends BasicService {
  constructor(public httpClient: HttpClient, public helperService: HelperService) {
    super('political', 'studyAbroad', httpClient, helperService);
  }
  ...
  public getListStudyAbroad(employeeId: number) {
    const empId = CommonUtils.nvl(employeeId);
    const url = `${this.serviceUrl}/${empId}/study-abroad`;
