...
export class RelativeAbroadService extends BasicService {
    constructor(public httpClient: HttpClient, public helperService: HelperService) {
        super('political', 'relativeAbroad', httpClient, helperService);
    }
    ...
    public getListRelativeAbroad(employeeId: number) {
        const empId = CommonUtils.nvl(employeeId);
        const url = `${this.serviceUrl}/${empId}/relative-abroad`;
