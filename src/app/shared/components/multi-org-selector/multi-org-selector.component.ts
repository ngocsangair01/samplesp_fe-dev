...
import { MultiOrgSelectorModalComponent } from './multi-org-selector-modal/multi-org-selector-modal.component';

@Component({
  selector: 'multi-org-selector',
  templateUrl: './multi-org-selector.component.html',
  styleUrls: ['./multi-org-selector.component.scss'],
})
export class MultiOrgSelectorComponent implements OnChanges {
  @Input()
   ...
   */
  public onChose() {
    const modalRef = this.modalService.open(MultiOrgSelectorModalComponent, DEFAULT_MODAL_OPTIONS);
