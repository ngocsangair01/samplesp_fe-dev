...
@Component({
  selector: 'parent-thorough-content-picker-modal',
  templateUrl: './parent-thorough-content-picker-modal.component.html',
})
export class ParentThoroughContentPickerModalComponent {
  @Input()
  params: any;
  form: FormGroup;
  resultList: any = {};
