...
@Component({
  selector: 'parent-thorough-content-picker',
  templateUrl: './parent-thorough-content-picker.component.html',
})
export class ParentThoroughContentPickerComponent implements OnInit, AfterViewInit, OnChanges {
  @Input()
   ...
   */
  public onChose() {
    const modalRef = this.modalService.open(ParentThoroughContentPickerModalComponent, {
      backdrop: 'static',
    });
    modalRef
      .componentInstance
