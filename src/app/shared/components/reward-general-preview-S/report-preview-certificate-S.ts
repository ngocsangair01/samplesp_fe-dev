...
declare var $: any;
@Component({
    selector: 'report-preview-certificate-S',
    templateUrl: './report-preview-certificate-S.component.html'
})
export class ReportPreviewCertificateComponentS extends BaseComponent implements OnInit {
